  ...
  constructor(    
    ...
    private route: ActivatedRoute
      ...
      this.router.events.pipe(
        filter(e => e instanceof NavigationEnd), // Listen only to NavigationEnd events
        map(e => this.route.firstChild), // Change the return of the observable to the first router
        switchMap(route => route?.data ?? of({})) // Return new empty observable if null
